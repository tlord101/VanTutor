...
export const Subscription: React.FC = () => {
  return (
    <div className="flex-1 flex flex-col h-full w-full items-center justify-center p-8">
        <div className="text-center bg-white dark:bg-black p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold  dark:text-white">Subscriptions Disabled</h2>
