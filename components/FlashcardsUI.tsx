      ...
      <footer className="px-6 py-10 flex flex-col items-center gap-6 border-t border-[#E2E8F0] shrink-0">
        <div className="flex gap-4 w-full max-w-sm">
          <button
            ...
            className="flex-1 h-14 flex items-center justify-center rounded-2xl bg-white dark:bg-black border border-[#E2E8F0] text-[#1E293B] font-bold text-xs uppercase tracking-widest hover:bg-[#F8FAFC] active:scale-95 transition-all disabled:opacity-30"
          >
            Previous
          </button>
          <button
