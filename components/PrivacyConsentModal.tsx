    ...
    >
      <div className="bg-white dark:bg-black border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-2xl w-full max-w-md relative privacy-modal-content">
        <div className="flex flex-col items-center text-center">
            ...
            <h2 id="privacy-title" className="text-2xl font-bold  dark:text-white">Your Privacy Matters</h2>
        ...
        <div className="flex justify-end gap-4 mt-8">
          <button
            onClick={onDeny}
            className="px-4 py-2 rounded-lg bg-gray-200  dark:text-white font-semibold hover:bg-gray-300 transition-colors"
          >
            Deny
          </button>
          <button
