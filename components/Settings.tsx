    ...
    <div className="p-4 sm:p-6 space-y-6 animate-in fade-in duration-300 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">We will send a secure link to your email to reset your password.</p>
            </div>
            <button
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
        <h3 className="text-lg font-bold text-slate-900 mb-6">Legal & Support</h3>
         <div className="divide-y divide-slate-100 border border-slate-100 rounded-xl overflow-hidden">
           <a
              href="/t&c"
              className="flex justify-between items-center w-full text-left p-4 bg-slate-50 text-slate-800 font-bold hover:bg-slate-100 transition-colors"
            >
      ...
      <div className="bg-red-50 p-6 sm:p-8 rounded-2xl border border-red-100 shadow-sm">
        ...
        <button
          ...
          className="px-6 py-2.5 bg-white border border-red-200 hover:border-red-300 text-red-600 text-sm font-bold rounded-xl transition-all shadow-sm"
        >
          Delete Account
        </button>
      </div>
