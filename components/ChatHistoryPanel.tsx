    ...
    <div className="h-full bg-white dark:bg-black flex flex-col p-4 animate-in fade-in duration-300">
      ...
      <div className="flex items-center justify-between mb-8">
          ...
          <button 
            ...
            className="p-2 text-charcoal dark:text-white hover:bg-off-white dark:hover:bg-[#0A101F] rounded-full transition-colors lg:hidden"
          >
      ...
      <div className="mt-auto space-y-4 pt-4 border-t border-gray-100 bg-white dark:bg-black">
        <div className="flex items-center gap-2">
            ...
            <button className="p-3 text-emerald dark:text-white hover:bg-off-white dark:hover:bg-[#0A101F] rounded-full transition-colors">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
