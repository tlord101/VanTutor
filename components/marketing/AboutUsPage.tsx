        ...
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-brand-500 selection:text-white">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-20">
                ...
                <div className="text-center max-w-3xl mx-auto space-y-6 mb-24">
                    <h1 className="text-5xl md:text-6xl font-black text-slate-900 tracking-tight">Our Mission</h1>
                ...
                <div className="mb-16 text-center">
                    <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-4">Meet the Founders</h2>
                    <p className="text-lg text-slate-500">The visionaries powering the future of learning.</p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {founders.map((founder) => (
                            <div key={founder.id} className="bg-white rounded-[32px] p-6 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition duration-300 border border-slate-100 flex flex-col group">
                                ...
                                <button
                                    ...
                                    className="w-full py-4 bg-slate-50 hover:bg-slate-100 text-slate-900 font-bold rounded-2xl flex items-center justify-center gap-2 transition"
                                >
