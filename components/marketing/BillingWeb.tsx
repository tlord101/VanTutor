            ...
            <header className="bg-white  shadow-sm sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold tracking-tight text-slate-800  <span className="font-light text-slate-500">Billing</span></span>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
                ...
                <section className="bg-white  rounded-3xl p-8 sm:p-12 shadow-sm border border-slate-200  relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-xl">
                        ...
                        <p className="text-slate-600  mb-8">Purchase credits on-demand to continue using AVELUT's powerful visual solver and AI tutor.</p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white  rounded-3xl p-8 border border-blue-200  shadow-xl shadow-blue-900/5 relative flex flex-col">
                            ...
                            <button 
                                ...
                                className="w-full py-3 px-4 rounded-xl font-bold bg-blue-50 text-blue-700 hover:bg-blue-100    transition-colors"
                            >
                                Upgrade to Student
                            </button>
                        </div>
