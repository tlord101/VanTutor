import { db, get, push, ref as dbRef, set } from '@/lib/backend';
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans selection:bg-amber-500 selection:text-slate-950">
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 md:py-20">
                ...
                >
                    <i className="bi bi-arrow-left text-lg"></i> Back to Home
                </button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-8 lg:col-span-1">
                        <div className="bg-white dark:bg-slate-900 rounded-[24px] p-8 shadow-xl border border-slate-200 dark:border-slate-800">
                            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Get in Touch</h3>
                            
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-full bg-amber-50 dark:bg-amber-950/40 flex items-center justify-center text-amber-500 shrink-0">
                                        <i className="bi bi-envelope text-lg"></i>
                                    </div>
                                    <div>
                                        <p className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-1">Email</p>
                                        <a href={`mailto:${supportEmail}`} className="text-base font-medium text-slate-900 dark:text-white hover:text-amber-500 transition">{supportEmail}</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-medium text-slate-900 dark:text-white">{supportPhone}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-medium text-slate-900 dark:text-white">{supportAddress}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 md:p-12 shadow-xl border border-slate-200 dark:border-slate-800">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl px-6 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl px-6 py-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition resize-none"
                                ...
                                <button 
                                    ...
                                    className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-2xl py-4 flex items-center justify-center gap-2 transition disabled:opacity-50 cursor-pointer shadow-md"
                                >
                                    {isSubmitting ? (
                                        <i className="bi bi-arrow-repeat animate-spin text-lg"></i>
                                    ) : (
                                        <>
                                            Send Message <i className="bi bi-send font-bold"></i>
                                        </>
                                    )}
                                </button>
                            </form>
