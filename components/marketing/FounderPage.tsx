...
export const FounderPage: React.FC<{ founderId: string }> = ({ founderId }) => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-[#0A101F] flex items-center justify-center">
    ...
    if (!founder) {
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-[#0A101F] flex flex-col items-center justify-center p-6 text-center">
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0A101F] font-sans selection:bg-brand-500 selection:text-white">
            ...
            <div className="max-w-4xl mx-auto px-6 py-12 md:py-20">
                ...
                <div className="bg-white dark:bg-[#121A2F] rounded-[32px] p-8 md:p-12 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col md:flex-row gap-12">
