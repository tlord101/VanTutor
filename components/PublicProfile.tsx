            ...
            <div className="relative px-6 pb-8 max-w-3xl mx-auto w-full -mt-16 sm:-mt-20">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-center mt-4 mb-6">
                        <h1 className="text-2xl sm:text-3xl font-black text-[#212529] dark:text-white tracking-tight">{targetUser.display_name}</h1>
                        <p className="text-sm font-bold text-[#009EE2] dark:text-[#F8F9FA] mt-1">{partnerCount} Connection{partnerCount !== 1 ? 's' : ''}</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white dark:bg-black p-6 rounded-3xl border border-[#E9ECEF] dark:border-white/10 shadow-sm space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-[#212529] dark:text-white font-bold">{privacy.public_school ? (targetUser.school_id?.replace(/_/g, ' ') || 'Not set') : 'Private'}</p>
                        </div>
                        <div>
                            <p className="text-[10px] font-bold text-[#ADB5BD] uppercase">Department</p>
                            <p className="text-[#212529] dark:text-white font-bold">{privacy.public_department ? (targetUser.department_id?.replace(/_/g, ' ') || 'Not set') : 'Private'}</p>
                        </div>
                        <div>
                            <p className="text-[10px] font-bold text-[#ADB5BD] uppercase">Level</p>
                            <p className="text-[#212529] dark:text-white font-bold">{privacy.public_level ? (targetUser.level ? `${targetUser.level} Level` : 'Not set') : 'Private'}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-black p-6 rounded-3xl border border-[#E9ECEF] dark:border-white/10 shadow-sm space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-[#212529] dark:text-white font-medium whitespace-pre-wrap">
