    ...
    return (
        <div className="max-w-4xl bg-white dark:bg-black rounded-3xl border border-slate-200 dark:border-white/10/60 shadow-sm p-6 sm:p-8 space-y-8">
            <div>
                ...
                <p className="text-sm text-slate-500 dark:text-gray-400">Send beautifully formatted HTML emails via your configured SMTP server.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] font-bold text-slate-500 dark:text-gray-400 uppercase tracking-wider">Subject</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] font-bold text-slate-500 dark:text-gray-400 uppercase tracking-wider">Body</label>
                        <textarea
                            rows={6}
