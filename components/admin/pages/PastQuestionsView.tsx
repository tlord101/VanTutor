        ...
        <div className="space-y-8 max-w-4xl">
            <div className="bg-white dark:bg-black rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-white/10/60 shadow-sm space-y-8">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-gray-400">Automate extraction using AI, or manually input individual questions.</p>
                </div>
                ...
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-black border border-slate-100 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <select 
                            ...
                            className="p-3 border border-slate-200 dark:border-white/10 rounded-xl bg-white dark:bg-black outline-none focus:ring-4 focus:ring-indigo-100 transition"
                        >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-6 rounded-2xl border-2 border-dashed border-indigo-200 bg-indigo-50/50 flex flex-col items-center justify-center text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-gray-400 max-w-[200px] mt-1">Our AI will automatically extract and format the questions and answers.</p>
                            </div>
                            ...
                            <div className="w-full space-y-3 pt-2">
                                <input
                                    ...
                                    className="w-full text-sm text-slate-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-indigo-100 file:text-indigo-700 hover:file:bg-indigo-200 cursor-pointer"
                                />
                                <button
                                    type="button"
                                    onClick={() => handleGoogleDrivePick((files) => setPqFile(files[0] || null))}
                                    className="w-full py-2.5 rounded-xl bg-white dark:bg-black text-blue-600 text-xs font-bold uppercase tracking-widest hover:bg-slate-50 dark:bg-black transition border border-slate-200 dark:border-white/10 flex items-center justify-center gap-2 shadow-sm"
                                >
                            ...
                            {isPQProcessing && (
                                <div className="w-full p-3 bg-white dark:bg-black rounded-xl border border-indigo-100 shadow-sm flex items-center justify-center gap-2 text-indigo-600 text-xs font-bold animate-pulse">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <textarea 
                                ...
                                className="w-full p-4 border border-slate-200 dark:border-white/10 rounded-2xl h-28 bg-slate-50 dark:bg-black focus:bg-white dark:bg-black outline-none focus:ring-4 focus:ring-indigo-100 transition resize-none text-sm"
                            />
                            ...
                            <textarea 
                                ...
                                className="w-full p-3 border border-slate-200 dark:border-white/10 rounded-xl h-20 bg-slate-50 dark:bg-black focus:bg-white dark:bg-black outline-none focus:border-indigo-500 resize-none text-sm"
                            />
