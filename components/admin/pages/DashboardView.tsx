        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {cards.map((card, idx) => {
                    ...
                    return (
                        <div key={idx} className="bg-white dark:bg-black rounded-3xl p-6 border border-slate-200 dark:border-white/10/60 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex items-center justify-between relative z-10">
                                ...
                                <button 
                                    ...
                                    className="w-8 h-8 rounded-full bg-slate-50 dark:bg-black border border-slate-100 flex items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-slate-100 transition-colors"
                                >
                            ...
                            <div className="mt-6 relative z-10">
                                ...
                                <p className="text-xs font-bold text-slate-500 dark:text-gray-400 uppercase tracking-widest mt-1">{card.title}</p>
                            </div>
                        </div>
                    );
                })}
