        ...
        <div className="space-y-8">
            ...
            <div className="flex gap-4 border-b border-slate-200 dark:border-white/10">
                <button 
                    ...
                    className={`pb-4 text-sm font-bold border-b-2 transition-colors flex items-center gap-2 ${activeTab === 'manage' ? 'border-lime-500 text-slate-900 dark:text-white' : 'border-transparent text-slate-500 dark:text-gray-400 hover:text-slate-700'}`}
                >
                ...
                <button 
                    ...
                    className={`pb-4 text-sm font-bold border-b-2 transition-colors flex items-center gap-2 ${activeTab === 'migrate' ? 'border-lime-500 text-slate-900 dark:text-white' : 'border-transparent text-slate-500 dark:text-gray-400 hover:text-slate-700'}`}
                >
            ...
            {activeTab === 'manage' && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    {/* Build Form */}
                    <div className="bg-white dark:bg-black rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-white/10/60 shadow-sm space-y-8">
                        <div>
                            <h3 className="font-black text-xl text-slate-900 dark:text-white mb-1">Create Academic Units</h3>
                            <p className="text-sm text-slate-500 dark:text-gray-400">Build your institution's hierarchy step-by-step.</p>
                        </div>
                        
                        <div className="space-y-6">
                            {/* School */}
                            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-black border border-slate-100 space-y-4">
                                ...
                                <div className="flex gap-3">
                                    <input 
                                        ...
                                        className="flex-1 px-4 py-3 border border-slate-200 dark:border-white/10 rounded-xl bg-white dark:bg-black text-sm outline-none focus:border-lime-500 focus:ring-4 focus:ring-lime-100 transition-all"
                                    />
                            ...
                            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-black border border-slate-100 space-y-4">
                                ...
                                <div className="space-y-3">
                                    <select value={selectedSchoolId} onChange={e => setSelectedSchoolId(e.target.value)} className="w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-xl bg-white dark:bg-black text-sm outline-none focus:border-lime-500 focus:ring-4 focus:ring-lime-100 transition-all">
                            ...
                            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-black border border-slate-100 space-y-4">
                                ...
                                <div className="space-y-3">
                                    <select value={selectedCollegeId} onChange={e => setSelectedCollegeId(e.target.value)} disabled={!selectedSchoolId} className="w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-xl bg-white dark:bg-black text-sm outline-none focus:border-lime-500 focus:ring-4 focus:ring-lime-100 transition-all disabled:opacity-50">
                    ...
                    {/* Preview List */}
                    <div className="bg-white dark:bg-black rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-white/10/60 shadow-sm space-y-6 sticky top-24">
                        <div>
                            <h3 className="font-black text-xl text-slate-900 dark:text-white mb-1">Active Departments</h3>
                            <p className="text-sm text-slate-500 dark:text-gray-400">Currently mapped in the system.</p>
                        </div>
                        
                        {allDepartments.length === 0 ? (
                            <div className="py-12 flex flex-col items-center justify-center text-slate-400 border-2 border-dashed border-slate-200 dark:border-white/10 rounded-2xl">
                            ...
                            <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                                {allDepartments.map(dept => (
                                    <div key={dept.id} className="p-4 rounded-2xl bg-white dark:bg-black border border-slate-200 dark:border-white/10 shadow-sm hover:shadow-md transition-all group flex flex-col gap-2">
                                        <div className="flex justify-between items-start">
                                            <h4 className="font-bold text-slate-900 dark:text-white">{dept.department_name}</h4>
                                        ...
                                        <div className="text-xs font-semibold text-slate-500 dark:text-gray-400 flex items-center gap-1.5 flex-wrap">
            ...
            {activeTab === 'migrate' && (
                <div className="max-w-3xl">
                    {oldDepartments.length === 0 ? (
                        <div className="bg-white dark:bg-black rounded-3xl p-12 border border-slate-200 dark:border-white/10/60 shadow-sm text-center flex flex-col items-center justify-center">
                            <div className="w-16 h-16 bg-green-50 text-green-500 rounded-full flex items-center justify-center mb-4">
                                <Database className="w-8 h-8" />
                            </div>
                            <h3 className="font-black text-xl text-slate-900 dark:text-white mb-2">No Legacy Data Found</h3>
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-3xl p-6 sm:p-10 border border-orange-200/60 shadow-sm space-y-8 relative overflow-hidden">
                            ...
                            <div className="space-y-6 relative z-10">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select value={migrateTargetDeptId} onChange={e => setMigrateTargetDeptId(e.target.value)} className="w-full p-4 border border-orange-200 rounded-2xl bg-white dark:bg-black text-sm font-semibold outline-none focus:ring-4 focus:ring-orange-500/20 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select value={migrateDestSchoolId} onChange={e => { setMigrateDestSchoolId(e.target.value); setMigrateDestCollegeId(''); }} className="w-full p-4 border border-orange-200 rounded-2xl bg-white dark:bg-black text-sm font-semibold outline-none focus:ring-4 focus:ring-orange-500/20 shadow-sm">
                                        ...
                                        {migrateDestSchoolId === 'new' && (
                                            <div className="pt-2 animate-in fade-in slide-in-from-top-2">
                                                <input type="text" placeholder="New School Name" value={migrateNewSchoolName} onChange={e => setMigrateNewSchoolName(e.target.value)} className="w-full p-4 border border-orange-300 rounded-2xl bg-white dark:bg-black text-sm outline-none focus:ring-4 focus:ring-orange-500/20 shadow-inner" />
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select value={migrateDestCollegeId} onChange={e => setMigrateDestCollegeId(e.target.value)} disabled={!migrateDestSchoolId} className="w-full p-4 border border-orange-200 rounded-2xl bg-white dark:bg-black text-sm font-semibold outline-none focus:ring-4 focus:ring-orange-500/20 shadow-sm disabled:opacity-50">
                                        ...
                                        {migrateDestCollegeId === 'new' && (
                                            <div className="pt-2 animate-in fade-in slide-in-from-top-2">
                                                <input type="text" placeholder="New College Name" value={migrateNewCollegeName} onChange={e => setMigrateNewCollegeName(e.target.value)} className="w-full p-4 border border-orange-300 rounded-2xl bg-white dark:bg-black text-sm outline-none focus:ring-4 focus:ring-orange-500/20 shadow-inner" />
                                            </div>
                                        )}
                                    </div>
                                </div>
