        ...
        <div className="space-y-8">
            ...
            {activeTab === 'manage' && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    {/* Preview List */}
                    <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/60 shadow-sm space-y-6 sticky top-24">
                        <div>
            ...
            {activeTab === 'migrate' && (
                <div className="max-w-3xl">
                    {oldDepartments.length === 0 ? (
                        <div className="bg-white rounded-3xl p-12 border border-slate-200/60 shadow-sm text-center flex flex-col items-center justify-center">
