                ...
                <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-slate-200 dark:border-white/10 pb-4 gap-4">
                        <div>
                            ...
                            <h3 className="text-3xl font-black text-slate-900 dark:text-white mt-1">{courseAdminView.level} Courses</h3>
                        </div>
                        {selectedCourses.size > 0 && (
                            <button
                                onClick={() => {
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0 pl-6">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <h4 className="font-bold text-slate-900 dark:text-white truncate group-hover:text-indigo-700">{course.course_name}</h4>
