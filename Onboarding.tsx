...
interface OnboardingProps {
    ...
    onComplete: (plan: 'free' | 'basic' | 'premium' | 'personal_token', extraData?: { apiKey: string }) => void;
}
    ...
    return (
        <div className="w-full max-w-5xl mx-auto py-8">
            <div className="text-center mb-10">
                ...
                <p className="text-slate-500 dark:text-gray-400 font-medium">Select the plan that best fits your academic goals.</p>
            </div>
